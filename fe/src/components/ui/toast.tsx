...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-14 left-0 right-0 z-[100] flex max-h-screen w-full flex-col items-center px-4",
      className
    )}
    {...props}
  />
